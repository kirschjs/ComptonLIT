...
C     CHECK NORM GT 0
 ...
 1401 FORMAT (14H EINGABEFEHLER ,3I3, 2E12.4)
      KONTRO=1
 1400 CONTINUE
...
C
     ...
     *          ALPHAR(NXH), ALPHAI(NXH), BETA(NXH)
...
C      IU= NZZ
      ...
      JOBVR='N'
      JOBVL='N'
      CALL DGEEV( JOBVL, JOBVR, NXH, H,NDIMD,EN,NDIMD, ALPHAR, ALPHAI,
     *                  VL, NDIMD, VR, NDIMD, IWORK, LWORK, IERR )
C      CALL DSYGVX(ITYPE,JOBZ,RANGE,UPLO,NX,H,NDIMD,EN,NDIMD,VL,VU,
C     *    IL,IU,ABSTOL,MOUT,Q,ZH,NDIMD,FC1,LWORK,IWORK,IFAIL,IERR)      

      WRITE (NOUT,1101)
C      WRITE (NOUT,1000) ( Q(M),M=1,NX )
      WRITE (NOUT,1000) ( ALPHAR(M)/BETA(M),M=1,NX )
C      WRITE (NOUT,1000) ( ALPHAI(M),M=1,NX )
      EOV = Q(1)
