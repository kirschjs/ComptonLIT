...
C     =============================
C
      PARAMETER (NZFMAX=20, NZCMAX=4, NZLWMA=14, LWMAX=6,
     *           NZIQMA=7, NZOPER=7, NZPOMA=10)
...
C
      PARAMETER (NDIMC=300, NDIMCW=191, NDIMK=81,
     *           NDIMOR=16000)
...
C     JJ IS DETERMINED IN SDA1 AND GIVES THE NUMBER OF SIGMA COMBINATIONS
      PARAMETER (NDIMCW=191, NZIQMA=7, NZCMAX=4, LWMAX=6,
     *           NDIMC=300)
      COMMON/SDA/CW(NDIMCW), MVM(NZIQMA,NDIMCW), KAUS,
     *           N5, IQ, NKAPO
      COMMON/FAKTOR/F3(2*LWMAX+1), F7(2*LWMAX+1),
...
C     I,K LAUFPARAMETER
C
      PARAMETER (NZCMAX=4, LWMAX=6, NDIMC=300)
      PARAMETER (NZIQMA=7, NDIMCW=191, NDIMOR=16000)
      PARAMETER (NZLMAX=3*(2*(NZCMAX-1)))
...
C     THE OCCURRING SIGMA FACTORS
      PARAMETER (NZIQMA=7, NDIMOR=16000, NDIMCW=191)
...
1002  FORMAT(' DIMENSION IN PORD ZU KLEIN,KZAHL=',2I5,'TES ELEMENT')
      ...
      PARAMETER (NZIQMA=7, NDIMOR=16000)
      COMMON /ORD/ KZAHL, JQ(NDIMOR),EPO(NDIMOR),
     *             INDPO(NDIMOR),MVK(NZIQMA,NDIMOR),
     *             INDEX(NDIMOR)
      ...
      PRINT 1000
      DO 10 KH=1,KZAHL
       PRINT 1010, JQ(KH),INDPO(KH),EPO(KH),INDEX(KH),
     *             (MVK(IH,KH),IH=1,IQM)
10    CONTINUE
20    CONTINUE
