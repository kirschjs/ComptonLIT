...
C               2*( Jl   Jr              m_jl m_L )  
      READ(5,1002)JWSL,JWSR,NPARL,NPARR,JWSLM,MULM2
...
C      F=YG(GJR,AK,GJL,GJR,AKM)
      F=CLG(INT(2*GJR),INT(2*AK),INT(2*GJL),
     1   INT(2*(GJLM-AKM)),INT(2*AKM))
